...
public class HelloWorldController {
	...
	public ModelAndView eastEgg(HttpServletRequest request) {
		ModelAndView modelAndView = new ModelAndView("hello_world");
		modelAndView.addObject("message", "you get an east egg.");
		return modelAndView;
	}
...
//		ModelAndView modelAndView = new ModelAndView("redirect:hello_world");
//		return modelAndView;
